...
export const Presentation = () => (
  <section className="flex flex-col md:flex-row justify-center gap-8 items-center py-8 md:py-16 md:px-8 w-full md:h-1/2-screen md:min-h-[26rem] relative bg-light">
